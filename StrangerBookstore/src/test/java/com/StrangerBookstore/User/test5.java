...
public class test5 {
    ...
    public void test(){
        ...
        driver.get(url3);
        driver.findElement(By.xpath("/html/body/div/div[2]/div/div/div[2]/div/a")).sendKeys(Keys.ENTER);
        driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[3]/div/div/div[2]/div/label/input")).sendKeys(Keys.ENTER);
