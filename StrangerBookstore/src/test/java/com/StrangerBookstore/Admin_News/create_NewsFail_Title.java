...
public class create_NewsFail_Title {
...
//        driver.findElement(By.id("admin")).sendKeys(Keys.ENTER);
        driver.get(url4);
        driver.findElement(By.cssSelector("#newsTitle")).sendKeys("");
        driver.findElement(By.id("textarea-input")).sendKeys("djfnsjfdnasnfsfdgghdfgsf");
