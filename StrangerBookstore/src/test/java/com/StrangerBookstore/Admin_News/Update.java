...
//
        ...
        driver.findElement(By.cssSelector("#newsTitle")).sendKeys("dù làấdafasfmưa");
        driver.findElement(By.id("textarea-input")).clear();
        driver.findElement(By.id("textarea-input")).sendKeys("Stranger bấdasfasdôkkk");
