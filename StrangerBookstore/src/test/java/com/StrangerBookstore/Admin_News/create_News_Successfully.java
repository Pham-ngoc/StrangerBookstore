...
public class create_News_Successfully {
...
//        driver.findElement(By.id("admin")).sendKeys(Keys.ENTER);
        driver.get(url4);
        driver.findElement(By.cssSelector("#newsTitle")).sendKeys("webấd sách");
        driver.findElement(By.id("textarea-input")).sendKeys("djfnsjfdnasfasfasdnfsfdgg");
