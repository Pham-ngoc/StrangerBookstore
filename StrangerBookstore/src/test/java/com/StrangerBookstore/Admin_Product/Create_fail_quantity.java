...
public class Create_fail_quantity {
    ...
    public void create(){
        ...
        driver.findElement(By.id("publisher")).sendKeys("11/03/2007");
...
//        driver.findElement(By.id("quantityInStock")).sendKeys("566");
        driver.findElement(By.xpath("//*[@id=\"quantityInStock \"]")).sendKeys("");
        driver.findElement(By.id("isbn")).sendKeys("874638463");
        driver.findElement(By.xpath("//*[@id=\"description\"]")).sendKeys("fsdfjsdfjdbuygsdf");
